...
MODELS = [
    ...
    (
        name="MultivariateT",
        model=MultivariateT([0.0, 0.0], [1.0 0.3; 0.3 1.0], 5.0),
        fresh=() -> MultivariateT([0.0, 0.0], Matrix(1.0I, 2, 2), 5.0),
        controlled=false,
        buffer=zeros(2),
    ),
    (
        name="MultivariateTDiag",
        model=MultivariateTDiag([0.0, 0.0], [1.0, 1.0], 5.0),
        fresh=() -> MultivariateTDiag([0.0, 0.0], [1.0, 1.0], 5.0),
        controlled=false,
        buffer=zeros(2),
    ),
]
